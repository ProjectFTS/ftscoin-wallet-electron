...
config.appName = 'FTSCoin';
config.appDescription = 'FTSCoin Wallet';
config.appSlogan = 'Fast and private!';
config.appId = 'lol.ftscoin.walletshell';
config.appGitRepo = 'https://github.com/ftscoin/ftscoin-wallet-electron';

// default port number for your daemon (e.g. TurtleCoind)
config.daemonDefaultRpcPort = 11898;

// wallet file created by this app will have this extension
config.walletFileDefaultExt = 'fts';

// change this to match your wallet service executable filename
config.walletServiceBinaryFilename = 'ftscoin-service';
...
config.blockExplorerUrl = 'http://explorer.ftscoin.xyz/?hash=[[TX_HASH]]#blockchain_transaction';

// default remote node to connect to, set this to a known reliable node for 'just works' user experience
config.remoteNodeDefaultHost = '69.10.35.254';
...
config.remoteNodeListFallback = [
  '206.72.192.145:11898',
  '199.231.188.238:11898',
  '199.231.188.241:11898',
];
config.remoteNodeCacheSupported = false;
config.remoteNodeSslSupported = false;

// your currency name
config.assetName = 'FTSCoin';
// your currency ticker
config.assetTicker = 'FTS';
// your currency address prefix, for address validation
config.addressPrefix = 'fts';
